  ...
  return (
    <div style={{ marginTop: '10px', marginBottom: '5px' }}>
      <div className="vertical-center" style={{ marginBottom: '15px' }}>
        ...
        {props.isEditable && props.isCollection && !props.isWishList && <Button className="match-btn" style={editBtnStyle} type="primary" size="small" ghost>
          <a href='/app/profile/collection/edit'><span style={{ fontWeight: 700 }}>Edit</span> </a>

        </Button> }

        {props.isEditable && !props.isCollection && props.isWishList && <Button className="match-btn" style={editBtnStyle} type="primary" size="small" ghost>
          <a href='/app/profile/wishlist/edit'><span style={{ fontWeight: 700 }}>Edit</span> </a>
