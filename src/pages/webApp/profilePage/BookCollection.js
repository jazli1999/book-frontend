...
export default function BookCollection(props) {
  ...
  return (
    ...
    <div className="center">
      <h3>
        <b>Book Collection  </b>
        <Button type="primary" shape="round" icon={<EditOutlined />} size="small" style={{ width: '100px' }} onClick={() => navigate('/app/profile/collection/edit')}>
          {' '}
          Edit
        </Button>
      </h3>
